...
namespace ExcellyGenLMS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250717082517_AddEnrollmentsToCourseAndFixIndexes")]
    partial class AddEnrollmentsToCourseAndFixIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExcellyGenLMS.Core.Entities.Course.Course", b =>
                {
                    ...
                    b.HasIndex("CreatorId")
                        .HasDatabaseName("IX_Courses_CreatorId");
            ...
            modelBuilder.Entity("ExcellyGenLMS.Core.Entities.Course.ExternalCertificate", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("external_certificate_id");
            ...
            modelBuilder.Entity("ExcellyGenLMS.Core.Entities.Course.QuizAttempt", b =>
                {
                    ...
                    b.HasIndex("IsCompleted", "Score")
                        .HasDatabaseName("IX_QuizAttempts_Completion_Score");
            ...
            modelBuilder.Entity("ExcellyGenLMS.Core.Entities.Learner.LearnerNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExcellyGenLMS.Core.Entities.Learner.UserActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
